export default class DailyValueIngredientsService {
    all () {
        ...
        return [
            ...
            {name: "Vitamin K", unit: "mcg", values: [80, null, null, null]},
            ...
            {name: "Folate", unit: "mcg", values: [400, 100, 200, 800]},
            {name: "Vitamin B12", unit: "mcg", values: [6.0, 2, 3, 8]},
            {name: "Biotin", unit: "mcg", values: [300, 50, 150, 300]},
            ...
            {name: "Iodine", unit: "mcg", values: [150, 45, 70, 150]},
            {name: "Magnesium", unit: "mg", values: [400, 70, 200, 450]},
            {name: "Zinc", unit: "mg", values: [15, 5, 8, 15]},
            {name: "Selenium", unit: "mcg", values: [70, null, null, null]},
            {name: "Copper", unit: "mg", values: [2.0, 0.6, 1.0, 2.0]},
            {name: "Manganese", unit: "mg", values: [2.0, null, null, null]},
            {name: "Chromium", unit: "mcg", values: [120, null, null, null]},
            {name: "Molybdenum", unit: "mcg", values: [75, null, null, null]},
